...
public class ArticleController {
	...
	public String addOneArticle(Model model, @RequestParam Map<String, Object> param, @RequestParam(value="addFiles") List<MultipartFile> files, @RequestParam(value="type", required=false) List<String> types, @RequestParam(value="type2", required=false) List<String> types2) {
		String resultCode = "";
		String redirectUrl = "";
